      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div style={{ background: '#111827', border: '1px solid #1e2d4a' }} className="rounded-2xl p-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-white font-bold text-lg">Raj Kapde</p>
              <p style={{ color: '#64748b' }} className="text-sm">Computer Engineering Student</p>
              <a href="https://github.com/Rajkapde/fake_news_detector" target="_blank" rel="noreferrer" style={{ color: '#60a5fa' }} className="text-sm hover:underline mt-1 inline-block">
                github.com/Rajkapde/fake_news_detector →
              </a>
            </div>
          </div>
        </div>
